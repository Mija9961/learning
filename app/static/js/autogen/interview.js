...
form.addEventListener("submit", function(e) {
    ...
    messageInput.value = "";
    $.post("/autogen/ask/interview", { message: msg }, function(data) {
...
<html>
<head>
<title>Autogen Mock Interview</title>
<meta charset="UTF-8">
...
<body>
<h1 style="text-align:center;">Autogen Mock Interview</h1>
<div id="chat-box">
${chatContent}
</div>
<script>
...
if ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window) {
    ...
    recognition.onend = () => {
        ...
        if (autoSendToggle.checked && finalTranscript.trim()) {
            ...
            $.post("/autogen/ask/interview", { message: finalTranscript.trim() }, function(data) {
                appendMessage("bot", data.response);
            });
